import { iconPrimaryColor, iconBgColor } from "../../data/iconthemedata";

export default function TypescriptIcon() {
  return (
    <>
      <div className="flex items-center gap-1 justify-between rounded-lg bg-black max-w-32 h-16 mx-1 my-2 p-2">
        <div className="grow shrink max-w-[50px] min-w-5">
          <svg
            ...
            viewBox="0 0 400 400"
          >
            <path d="M0 200V0h400v400H0" fill={iconPrimaryColor} />
            <path
