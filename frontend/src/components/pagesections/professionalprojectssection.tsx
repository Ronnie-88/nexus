...
export default function ProfessionalProjectsSection() {
  ...
  return (
    <section className="flex gap-8 items-center mx-auto px-96 py-10 text-white mt-10">
      <div className=" space-y-10">
        <h1 className="text-6xl">Professional Projects</h1>
        {projects && (
          <>
            <ul className="flex gap-10">
              {projects.proProjectList.map((projectCard) => {
                return (
                  <li>
                    {
                      <ProjectCard
